---
title: "Roboflow, Introduction to YOLO & CUDA Installation"
...
image: "https://raw.githubusercontent.com/wildanaziz/TL-Vision/refs/heads/main/assets/img/roboflow.png"
author: "Wildan Aziz"
tags: ["Computer Vision", "YOLO", "Tutorial", "Best Practices"]
---

import YouTube from '../../components/YouTube.jsx';

# Roboflow, Introduction to YOLO & CUDA Installation

<YouTube videoId="87c5-ThfW1k" title="YOLO and CUDA Installation Tutorial" />

Pada tutorial kali ini kita akan mengulas **Roboflow** yang telah diajarkan oleh **Core Team**, menerapkan [reqiurements](#requirements) bagi yang belum melakukannya, serta melakukan pengenalan dan praktik langsung (*hands-on*) menggunakan **YOLO** 🤗.
...
> **⚠️ Peringatan:** Hati-hati jangan menyebarkan API_KEY karena bersifat sensitif.
