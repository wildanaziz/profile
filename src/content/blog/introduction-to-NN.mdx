---
title: "Introduction to NN (Neural Network)"
...
image: "https://raw.githubusercontent.com/wildanaziz/TL-Vision/refs/heads/main/assets/img/matriks.png"
author: "Wildan Aziz"
tags: ["Neural Network", "Tutorial", "Intermediate", "Python", "Mathematics", "Image Classification"]
---

# Introduction to NN (Neural Network)

Pada tutorial kali ini kita akan mengulik dalam-dalam bersama terkait Neural Network. Dimana kita akan membahas secara perhitungan matematis dan implementasi dari Neural Network menggunakan pendekatan coding. So, buat para vision amarineers cuss kita ulik.
...
Nahh mungkin cukup sampe disini aja buat tutorial kali ini pabila bingung bisa tanyain digrup or u can get in touch with me: https://wildanaziz.vercel.app/

Selamat belajar! feel free to ask me anything about this blog.