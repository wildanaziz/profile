...
category: "robotics"
image: "../../public/assets/SUMOBOT.png"
...
2. **Ultrasonic Sensors**: HC-SR04 × 3 (front, left, right)
3. **Line Sensors**: IR reflective × 6 (edge detection)
4. **IMU**: MPU6050 (gyroscope + accelerometer)

#### Actuators
1. **Motors**: DC Geared Motors 12V 200RPM × 2
2. **Motor Drivers**: L298N Dual H-Bridge × 2
...
|-------|----------|--------|---------|
| RoboSumo Championship 2023 | Surabaya | **1st Place** 🏆 | 12-2 |
| National Robotics Challenge | Jakarta | **2nd Place** 🥈 | 10-3 |
| PENS Robotics Competition | Campus | **1st Place** 🏆 | 8-0 |
| East Java Regional | Malang | **3rd Place** 🥉 | 9-4 |
...
Battery (11.1V 2200mAh LiPo)
    |
    ├── BEC (5V) → Raspberry Pi + Servo
    ├── BEC (5V) → Arduino + Sensors
    └── Direct → Motor Drivers (12V)
```

### Assembly Timelapse
1. Design CAD model → 3 days
2. Fabricate frame → 2 days
3. Wire electronics → 1 day
4. Software development → 1 week
5. Testing & calibration → 3 days
6. Competition preparation → 2 days
...
- **Sensors**: LIDAR for 360° awareness
